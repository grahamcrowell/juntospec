...
- Effort selection: tier-routine for mechanical edits, tier-implementation for structured work, tier-reasoning for ambiguous problems (the tier sets reasoning depth; capability is set separately by the role's model class, authoring or advisory)
